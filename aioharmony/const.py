...
SendCommandDevice = NamedTuple(
    "SendCommandDevice", [("device", int), ("command", str), ("delay", float)]
)
...
SendCommandResponse = NamedTuple(
    "SendCommandResponse", [("command", SendCommandDevice), ("code", str), ("msg", str)]
)
